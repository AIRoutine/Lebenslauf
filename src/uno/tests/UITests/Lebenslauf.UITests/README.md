...
Shared UI-Test-Infrastruktur fuer das Lebenslauf Projekt basierend auf **Uno.UITest**.
...
```csharp
using Lebenslauf.UITests.Infrastructure;

namespace Lebenslauf.Features.Auth.UITests.Tests;
...
```csharp
using Lebenslauf.UITests.PageObjects;

namespace Lebenslauf.Features.Auth.UITests.PageObjects;
...
| `UITEST_ANDROID_PACKAGE` | Android Package Name | `com.companyname.lebenslauf` |
| `UITEST_ANDROID_APK` | Pfad zur APK (CI/CD) | - |
| `UITEST_IOS_BUNDLE` | iOS Bundle ID | `com.companyname.lebenslauf` |

...
|--------|-----------|---------|----------|--------|
| `ApiService` | `Lebenslauf.Api` | `src/api/src/Shared/Api.Shared` | `Scoped` | `true` |
| `UnoService` | `Lebenslauf` | `src/uno/src/Shared/Shared` | `Singleton` | `true` |
...
|-----|--------|-----------|
| Features | `src/api/src/Features/` | `Lebenslauf.Api.Features.{FeatureName}` |
| Core Features | `src/api/src/Core/` | `Lebenslauf.Api.Core.{FeatureName}` |

### API Feature Hauptprojekt

```
src/api/src/Features/{FeatureName}/Lebenslauf.Api.Features.{FeatureName}/
...
```
src/api/src/Features/{FeatureName}/Lebenslauf.Api.Features.{FeatureName}.Contracts/
├── README.md                             # Projektdokumentation (PFLICHT)
└── Mediator/
    └── Requests/
...
**Auto-Discovery:** Entities die von `BaseEntity` erben und `IEntityTypeConfiguration<T>` Implementierungen werden automatisch aus allen `Lebenslauf.*` Assemblies geladen - keine manuelle Registrierung noetig.
...
| Typ | Ordner | Benennung |
|-----|--------|-----------|
| Features | `src/uno/src/Features/` | `Lebenslauf.Features.FeatureName` |
| Core Features | `src/uno/src/Core/` | `Lebenslauf.Core.FeatureName` |
| Third Party | `src/uno/src/ThirdParty/` | `Lebenslauf.ThirdParty.FeatureName` |

### Contracts-Projekt

```
src/uno/src/Features/{FeatureName}/Lebenslauf.Features.{FeatureName}.Contracts/
├── README.md                     # Projektdokumentation (PFLICHT)
...
```
src/uno/src/Features/{FeatureName}/Lebenslauf.Features.{FeatureName}/
├── README.md                     # Projektdokumentation (PFLICHT)
├── Configuration/
│   └── ServiceCollectionExtensions.cs    # Add{FeatureName}Feature()
├── Services/
